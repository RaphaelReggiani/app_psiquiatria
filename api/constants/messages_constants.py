...
API_ERROR_AGENDAMENTO_PASSADO = "Não é permitido criar consulta para agendamento no passado."
...
API_ERROR_STATUS_NAO_REALIZADO = "Consulta só pode ser registrada para agendamento realizado."
